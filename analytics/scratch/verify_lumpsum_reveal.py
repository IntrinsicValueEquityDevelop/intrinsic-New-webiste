...
def main():
    ...
    try:
        ...
        print("Loading Lumpsum page...")
        driver.get("http://127.0.0.1:8000/lumpsum")
        time.sleep(3)
        
        # Capture Initial State
        initial_path = os.path.join(ARTIFACT_DIR, "lumpsum_initial_load.png")
        ...
        amount_input = driver.find_element(By.ID, "ivLumpsumAmount")
        amount_input.clear()
        amount_input.send_keys("2500000")
        
        cagr_input = driver.find_element(By.ID, "ivLumpsumCagr")
        cagr_input.clear()
        cagr_input.send_keys("13.5")
        
        years_input = driver.find_element(By.ID, "ivLumpsumYears")
        years_input.clear()
        years_input.send_keys("20")
        time.sleep(0.5)
        
        # Click Calculate
        print("Clicking Calculate Lumpsum button...")
        calc_btn = driver.find_element(By.ID, "ivLumpsumCalculate")
        driver.execute_script("arguments[0].click();", calc_btn)
        time.sleep(2)
        
        # Capture Calculated State
        calc_path = os.path.join(ARTIFACT_DIR, "lumpsum_calculated_state.png")
        ...
        table_card = driver.find_element(By.ID, "ivLumpsumTableCard")
        ...
        expanded_path = os.path.join(ARTIFACT_DIR, "lumpsum_table_expanded.png")
        ...
        reset_btn = driver.find_element(By.ID, "ivLumpsumReset")
        driver.execute_script("arguments[0].click();", reset_btn)
        time.sleep(1)
        
        # Capture Reset State
        reset_path = os.path.join(ARTIFACT_DIR, "lumpsum_reset_state.png")
